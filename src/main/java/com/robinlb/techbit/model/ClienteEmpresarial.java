...
public class ClienteEmpresarial implements Serializable {
  ...
  public ClienteEmpresarial(Long clienteEId, String razonSocial, String nombreComercial, String ruc, String telefono, String email, String estado) {
  ...
  public String toString() {
    return "ClienteEmpresarial{" + "clienteEId=" + clienteEId + ", razonSocial=" + razonSocial + ", nombreComercial=" + nombreComercial + ", ruc=" + ruc + ", telefono=" + telefono + ", email=" + email + ", estado=" + estado + '}';
  }
